...
const Services = () => {
  const services = [{
    ...
    features: ["One-on-one personalized sessions", "Logic building and problem-solving", "Project-based learning approach", "Exam preparation and guidance"],
  ...
  return <section id="services" className="py-20 bg-card">
      <div className="max-w-7xl mx-auto section-padding">
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-20">
          {services.map((service, index) => <Card key={index} className="p-8 bg-background border-border hover:border-primary transition-all duration-300 group hover:shadow-2xl hover:shadow-primary/10 h-full">
              <div className="space-y-6 h-full flex flex-col">
                ...
                <div className="space-y-4 mt-auto">
                  ...
                  <Button className="w-full glow-effect" onClick={() => document.getElementById('contact')?.scrollIntoView({
                behavior: 'smooth'
              })}>
                    Book Session
                  </Button>
        ...
        <div className="mb-20">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            icon: Code,
            title: "Planning",
            desc: "Creating a structured approach"
          }, {
            icon: Clock,
            title: "Execution",
            desc: "Delivering quality work on time"
          }, {
            icon: Star,
            title: "Support",
            desc: "Ongoing guidance and assistance"
          }].map((step, index) => <div key={index} className="text-center space-y-4">
        ...
        <div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {testimonials.map((testimonial, index) => <Card key={index} className="p-6 bg-secondary border-none">
